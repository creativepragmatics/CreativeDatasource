...
open class DefaultCollectionViewController<Datasource: DatasourceProtocol, CellViewProducer: TableViewCellProducer> : UIViewController where CellViewProducer.Item : DefaultListItem, CellViewProducer.Item.E == Datasource.State.E {
